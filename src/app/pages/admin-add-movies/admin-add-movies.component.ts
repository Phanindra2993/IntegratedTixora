...
//   standalone: true,
//   imports: [CommonModule, HeaderComponent, ReactiveFormsModule, RouterLink, FooterComponent],
...
@Component({
  selector: 'app-admin-add-movies',
  standalone: true,
  imports: [CommonModule, HeaderComponent, ReactiveFormsModule, RouterLink, FooterComponent,FormsModule],
  templateUrl: './admin-add-movies.component.html',
  styleUrls: ['./admin-add-movies.component.scss'],
})
export class AdminAddMoviesComponent implements OnInit {
